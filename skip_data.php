...
$query_update = "UPDATE haloo_list SET status='Skip',modify_date=now(),hp_status=3 WHERE label_phone_number='$phoneNumber' AND campaign='$campaign' ORDER BY lead_id DESC LIMIT 1";
